...
namespace eeduro {
	namespace delta {
		class CircleMoveSequence : public Sequence {
			public:
				CircleMoveSequence(std::string name, Sequence* caller, DeltaControlSystem& controlSys, Calibration& calibration, DeltaSafetyProperties &properties);
				int action();
